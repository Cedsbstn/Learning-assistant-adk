...
# Thinking budget for reasoning agents
...
def generate_markdown_output(callback_context: CallbackContext, **kwargs) -> None:
    ...
    parts.extend([
        "\n---\n\n",
        "*Generated by Learning Agent ADK*\n"
    ])
...
markdown_generator = LlmAgent(
    ...
    instruction="""
    You are a distinguished Professor in the general field of study. Create the final, polished curriculum document.
    ...
    **MARKDOWN ENHANCEMENTS:**
    - Use emoji (but less frequently) for visual markers (📚 🎯 ⚡ 💡 ⚠️ ✅)
